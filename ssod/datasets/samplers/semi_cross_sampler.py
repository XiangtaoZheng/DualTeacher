...
class DistributedGroupSemiCrossBalanceSampler(Sampler):
    def __init__(
        self,
        dataset,
        by_prob=False,
                ...
                while batch_idx < self.epoch_length[i] * self.num_replicas:
                    ...
                    if self.by_prob:
                        ...
                        for u, c in zip(unique, counts):
                            ratio[u] = c
                        assert len(ratio) == 3, "Only three set is supported"
                        if ratio[0] == 0:
                            ratio[0] = 1
                            if ratio[1] >= ratio[2]:
                                ratio[1] -= 1
                        ...
                        if ratio[2] == 0:
                            ...
                            if ratio[1] >= ratio[0]:
                                ...
                                ratio[0] -= 1
                        assert ratio[0] > 0 and ratio[1] > 0 and ratio[2] > 0
